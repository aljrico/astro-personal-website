...
description: "Unified ore icons, stripped the Smith page down to what matters, small expedition touch"
...
Evening was lighter. Added a duration label under the DESCEND button on the expedition sheet — clock icon, minutes, done. One file. Sometimes the best changes are the ones that take five minutes and make you wonder why they weren't there from the start.

Also discovered the devlog scratch system was broken. Hook was firing, notes weren't landing. Fixed it mid-session, then had to go back and strengthen the wording to make it actually stick. Meta productivity: fixing the tool that documents productivity, then fixing the fix. At least now there's a record.
```
