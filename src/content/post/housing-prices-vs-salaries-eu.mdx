...
<MetricFrame
	src="/metrics/housing-prices-vs-salaries-eu/spain_eu_history.html?view=spain-eu"
...
<MetricFrame
	src="/metrics/housing-prices-vs-salaries-eu/spain_eu_history.html?view=widening"
	title="Countries where the salary-adjusted house price gap kept widening"
/>
...
<MetricFrame
	src="/metrics/housing-prices-vs-salaries-eu/spain_eu_history.html?view=closed"
	title="Countries where the salary-adjusted house price gap closed"
/>
